...
public interface ConstantTargetName {
  ...
  String IdButtonComment = "com.tencent.mm:id/clj";//朋友圈 评论按钮
  String IdListViewCommentLast = "com.tencent.mm:id/coc";//朋友圈最新消息 列表控件
  String IdLayoutCommentLastItem = "com.tencent.mm:id/om";//朋友圈最新消息 列表项
  String IdButtonMenuComment = "com.tencent.mm:id/cko";//朋友圈 评论弹出菜单的评论按钮
  ...
  String ClassSnsTimeLineUI = "com.tencent.mm.plugin.sns.ui.En_424b8e16";//朋友圈列表页
  String ClassSnsTimeLineUploadUI = "com.tencent.mm.plugin.sns.ui.En_c4f742e5";//朋友圈页发布页
  String ClassSnsTimeMsgUI = "com.tencent.mm.plugin.sns.ui.SnsMsgUI";//朋友圈新消息列表页
  ...
  String ClassFMessageConversationUI =
      "com.tencent.mm.plugin.subapp.ui.friend.FMessageConversationUI";//新朋友功能列表
  ...
  //适配 6.5.10版本
  String IdListViewTimeLineCommentDetail = "com.tencent.mm:id/cr1";//朋友圈详情页 ListView

  String IdTextTimeLineAuthor = "com.tencent.mm:id/aig";//朋友圈详情页 作者名称
  String IdLayoutTimeLineDetailListItem = "com.tencent.mm:id/crq";//朋友圈评论详情页 ListView的itemLayout
  String IdTextViewTimeLineDetailItemName = "com.tencent.mm:id/cru";//朋友圈详情 列表项 用户名
  String IdTextViewTimeLineDetailItemContent = "com.tencent.mm:id/crw";//朋友圈详情 列表项 评论内容
  String IdEditTimeLineComment = "com.tencent.mm:id/cry";//朋友圈评论 输入框
