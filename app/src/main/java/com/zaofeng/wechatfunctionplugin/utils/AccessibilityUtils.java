...
public class AccessibilityUtils {
    ...
    public static List<AccessibilityNodeInfo> findViewListById(AccessibilityService service, String id) {
        AccessibilityNodeInfo info = service.getRootInActiveWindow();
        return getListAccessibilityNodeInfos(info, id, true);
    }

    public static List<AccessibilityNodeInfo> findViewListById(AccessibilityNodeInfo info, String id) {
        return getListAccessibilityNodeInfos(info, id, true);
    }

    public static List<AccessibilityNodeInfo> findViewListByText(AccessibilityService service, String text) {
        AccessibilityNodeInfo info = service.getRootInActiveWindow();
        return getListAccessibilityNodeInfos(info, text, false);
    }

    public static List<AccessibilityNodeInfo> findViewListByText(AccessibilityNodeInfo info, String text) {
        return getListAccessibilityNodeInfos(info, text, false);
    }
    ...
    public static AccessibilityNodeInfo findViewClickByText(AccessibilityService service, String text) {
        AccessibilityNodeInfo info = service.getRootInActiveWindow();
    ...
    private static List<AccessibilityNodeInfo> getListAccessibilityNodeInfos(AccessibilityNodeInfo info, String key, boolean isId) {
        if (info == null || TextUtils.isEmpty(key)) return Collections.emptyList();
     ...
     * @return 查找成功的节点
     */
    private static AccessibilityNodeInfo getAccessibilityNodeInfo(AccessibilityNodeInfo info, String key, boolean isId) {
        if (info == null || TextUtils.isEmpty(key)) return null;
        List<AccessibilityNodeInfo> infos;
        if (isId) {
            infos = info.findAccessibilityNodeInfosByViewId(key);
        } else {
     ...
     * @return 查找成功的可点击节点
     */
    private static AccessibilityNodeInfo getAccessibilityClickNodeInfo(AccessibilityNodeInfo info, String key, boolean isId) {
